...
<nav class="navbar-shell" aria-label="Main navigation">
  ...
  <button class="nav-hamburger" id="navToggle" type="button" aria-label="Toggle navigation menu" aria-expanded="false" aria-controls="navMenu">
  ...
  <div class="nav-menu" id="navMenu">
    ...
    <div class="nav-actions">
      <a href="<?= h(base_url('shop/wishlist.php')) ?>" class="nav-icon text-decoration-none" title="Wishlist" aria-label="Open wishlist">🤍<span class="badge"><?= wishlist_count() ?: '' ?></span></a>
      ...
      <?php if ($user): ?>
        ...
        <?php endif; ?>
        <a href="<?= h(base_url('shop/orders.php')) ?>" class="btn-member" style="background:var(--sage);">My Orders</a>
